/**
 * @file
 * Implementation of an USB HID device on the MCXA153
 *
 ...
 *     Author: Bernd Kreuss
 * Ported to MCXA153 on: 17.02.2024
 *     Author: Hugo Arends
 *
 ...
 */
WEAK void usb_hook_led_rx(bool on __attribute__((unused))) {}
WEAK void usb_hook_led_tx(bool on __attribute__((unused))) {}
WEAK void usb_hook_message_packet(volatile uint8_t* data __attribute__((unused))) {}
...
void usb_device_init(void) {
    ...
    MRCC0->MRCC_USB0_CLKSEL = MRCC_MRCC_USB0_CLKSEL_MUX(1); // CLK_48M

    //2: Ungate USB clock
    MRCC0->MRCC_GLB_CC0_SET = MRCC_MRCC_GLB_CC0_USB0(1);
    MRCC0->MRCC_GLB_RST0_SET = MRCC_MRCC_GLB_RST0_USB0(1);
