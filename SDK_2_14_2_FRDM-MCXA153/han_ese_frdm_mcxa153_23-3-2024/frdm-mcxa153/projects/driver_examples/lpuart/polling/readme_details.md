...
To keep the projects nice and clean, all these functions have been implemented in the file retarget.c. Notice the use of the defines *MDKARM* and *\__NEWLIB__* for conditional compilation for both compilers.
